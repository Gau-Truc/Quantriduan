	<header class="site-header">
		<div class="site-top hidden-md-down">
			<div class="container">
				...
				<ul class="site-user">
					...
					<li>
						<a class="toggle-module-login" href="dangnhap.php"><i class="fa fa-lock"></i>Đăng nhập</a>
						<div class="module-login">
							...
							<div class="module-content">
								...
								<p class="no-account">Bạn chưa có tài khoản? <a href="dangky.php">Đăng ký ngay</a></p>
							</div>
						</div>
					</li>
				</ul>
		...
		<div class="site-branding">
			<div class="container">
				...
				<a class="site-cart" href="dangnhap.php">
		...
		<div class="mobile-nav hidden-lg-up">
			<ul class="site-user mobile-user">
				...
				<li class="separator">|</li>
				<li><a href="dangnhap.php"><i class="fa fa-lock"></i>Đăng nhập</a></li>
			</ul>
			<ul class="menu">
